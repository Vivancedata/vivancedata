      ...
      <div className="flex flex-col md:flex-row gap-12 mb-20">
        <AnimateOnScroll variant="fadeInLeft" className="w-full md:w-1/2">
          <div className="aspect-video rounded-md overflow-hidden border border-border bg-card p-6 md:p-8 flex flex-col">
            <div className="eyebrow mb-4">Clinical Workflow Intelligence</div>
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="bg-muted border border-border rounded-sm p-3">
                <div className="text-mute text-xs mb-1">Chart Review Time</div>
                <div className="text-2xl font-bold text-brand">↓ 40%</div>
                <div className="text-mute text-xs">per encounter</div>
              </div>
              <div className="bg-muted border border-border rounded-sm p-3">
                <div className="text-mute text-xs mb-1">Documentation Accuracy</div>
                <div className="text-2xl font-bold text-brand">97.3%</div>
                <div className="text-mute text-xs">structured capture</div>
              </div>
            </div>
            <div className="space-y-2">
              {[
                { label: "HIPAA-compliant data processing", color: "bg-primary" },
                { label: "NLP-assisted clinical summarization", color: "bg-brand" },
                { label: "Human-in-the-loop review workflows", color: "bg-brand" },
              ].map((item) => (
