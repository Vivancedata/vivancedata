  ...
  solutions: [
    {
      ...
      icon: <Wrench className="h-6 w-6 text-mute" />,
    ...
    },
    {
      ...
      icon: <Shield className="h-6 w-6 text-mute" />,
    ...
    },
    {
      ...
      icon: <Activity className="h-6 w-6 text-mute" />,
    ...
    },
    {
      ...
      icon: <Settings className="h-6 w-6 text-mute" />,
    ...
    },
    {
      ...
      icon: <BarChart3 className="h-6 w-6 text-mute" />,
