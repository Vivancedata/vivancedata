  ...
  return (
    <Container className="py-16 overflow-hidden">
          ...
          <div className="aspect-video rounded-md overflow-hidden border border-border bg-card p-6 md:p-8 flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="bg-muted border border-border rounded-sm p-3">
                <div className="text-mute text-xs mb-1">Stockout Risk</div>
                <div className="text-2xl font-bold text-brand">↓ 28%</div>
                <div className="text-mute text-xs">pilot categories</div>
              </div>
              <div className="bg-muted border border-border rounded-sm p-3">
                <div className="text-mute text-xs mb-1">Planning Speed</div>
                <div className="text-2xl font-bold text-brand">↑ 35%</div>
                <div className="text-mute text-xs">replenishment cycles</div>
              </div>
            </div>
            <div className="space-y-2">
              {[
                { label: "Demand forecasting with seasonality signals", color: "bg-primary" },
                { label: "Inventory risk scoring by category", color: "bg-brand" },
                { label: "Promotion and markdown optimization", color: "bg-brand" },
              ].map((item) => (
      ...
      <AnimateOnScroll variant="fadeIn" className="mb-20 bg-muted rounded-xl p-8 md:p-12 shadow-lg">
        <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">Where AI Earns Its Keep in Retail</h2>
