      ...
      <div className="relative">
        ...
        <AnimateOnScroll variant="fadeInUp" className="flex flex-col items-center justify-center text-center space-y-6 mb-20">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight leading-tight">
            Transforming Businesses Through <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent">Intelligent Automation</span>
          </h2>
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="flex flex-col p-8 bg-white rounded-2xl shadow-xl border border-gray-100 hover:shadow-2xl hover:border-primary/20 transition-all duration-500 group"
            >
              <div className="rounded-2xl bg-primary/5 p-4 w-fit mb-6 group-hover:bg-primary/10 transition-colors duration-300">
                <motion.div
        ...
        <AnimateOnScroll variant="fadeInUp" className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-12">
          <Button className="bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-primary-foreground px-8 py-7 h-auto text-lg font-medium rounded-xl shadow-lg shadow-primary/20 transition-all duration-300 hover:shadow-xl group">
            <span>Explore Our Services</span>
            <ChevronRight className="ml-2 h-5 w-5 transition-transform duration-300 group-hover:translate-x-1" />
          </Button>
          <Button variant="outline" className="border-primary text-primary hover:bg-primary/5 px-8 py-7 h-auto text-lg font-medium rounded-xl transition-all duration-300">
